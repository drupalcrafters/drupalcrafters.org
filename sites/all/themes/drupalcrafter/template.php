 ...
 */
function drupalcrafter_preprocess_html(&$vars) {
  ...
  $media_queries_css = array(
    'drupalcrafter.responsive.style.css',
    'drupalcrafter.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'drupalcrafter'); // Replace 'footheme' with your themes name
